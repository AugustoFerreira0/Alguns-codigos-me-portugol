...
//- A aplicação deve percorrer os valores entre 1 e o número informado;
//- Cada número par (contador) deve ser somado ao valor da variável resultado;
//- Cada número ímpar (contador) deve ser subtraído do valor da variável resultado;
